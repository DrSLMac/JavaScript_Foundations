...
describe("Weather prompts", () => {
  it("should return a list of all average temperatures", () => {
    ...
    it("should return a list of locations that are sunny and mostly sunny", () => {
    ...
    it("should return the location with the highest humidity", () => {
